...
Description: This is a simple cipher written in PyOpenCL. This program accepts uppercase and lowercase inputs; however, it does not accept numberic valuse. The output will be in all uppercase."
